...
const ModalComponent = ({ isVisible, handleOk, handleCancel }) => {
    ...
    async function generateAnswer(e) {
        ...
        try {
            const response = await axios({
                url: "https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=AIzaSyDrV4IcKmDyE0_gdhIUJXeNOAJa8UvTWVs",
                method: "post",
                data: {
    ...
    return (
        <Modal title="Chatbox" visible={isVisible} onOk={handleOk} onCancel={handleCancel}>
